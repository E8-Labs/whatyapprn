...
const ReviewNotificationScreen = ({ navigation, route }) => {
            ...
            return (
                <View style={{
                    ...
                    <Text numberOfLines={2} style={[GlobalStyles.text17, { color: "black" }]}>
                        Settlement Offer ${item.settlementAmount && formatAmount(item.settlementAmount)} was paid
                    </Text>
                </View>
            )
            ...
            return (
                <View style={{
                    ...
                    <Text numberOfLines={2} style={[GlobalStyles.text17, { color: Colors.orangeColor }]}>
                        Settlement Offer ${item.settlementAmount && formatAmount(item.settlementAmount)}
                    </Text>
                </View>
            )
        }
                                    ...
                                    <View style={{
                                        ...
                                        <View style={{ width: screenWidth - 40, alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' }}>
                                            <View style={{ alignItems: 'center', flexDirection: 'row', gap: 8 }}>
                                                ...
                                                <Image source={review.fromUser.profile_image ? { uri: review.fromUser.profile_image } : placeholderImage}
                                            ...
                                            <View style={{ flexDirection: 'column', alignItems: 'flex-start', gap: 10, marginLeft: 20, width: 330 / 430 * screenWidth }}>
                                                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                                                    <Text style={{
                                                        ...
                                                        {review.review.service} (${formatAmount(review.review.amountOfTransaction)})
                                                    </Text>

                                                </View>

                                                <Text style={[GlobalStyles.text14, { color: '#00000090' }]}>
                                                    Transaction date: {review.review.dateOfTransaction?.replace(/\s+/g, '')}
                                                </Text>

                                                {
                                                    review.review.media?.length > 0 && (
                                                ...
                                                {
                                                    review.review.settlementOffer && (
                                                        selectSettleView(review.review)
                                                    )
                                                }
                                                    ...
                                                    <View style={{ width: screenWidth - 60, alignItems: 'flex-end', flexDirection: 'row', justifyContent: 'space-between' }}>
                                                        <View style={{ flexDirection: 'column', gap: 10 }}>
                                                            <View style={{ flexDirection: 'row', gap: 10, alignItems: 'center' }}>
                                                                ...
                                                                />
                                                                <Text style={GlobalStyles.text17} > {review.fromUser.name}</Text>
                                                                <Text style={[GlobalStyles.text12, { color: Colors.orangeColor }]} > Company</Text>
                                                            </View>
                                                            <Text style={GlobalStyles.text12} > {review.fromUser.city} {review.fromUser.state}</Text>
                                                            <View style={{ flexDirection: 'row', gap: 0, alignItems: 'center' }}>
                                                                <Image source={require('../../assets/Images/starIcon.png')}
                                                                    style={{ height: 14, width: 14, tintColor: '#FFC107' }}
                                                                />

                                                                <Text style={GlobalStyles.text12} > {review.fromUser.totalReviews} reviews</Text>
                                                        ...
                                                        <View style={{ flexDirection: 'column', gap: 6 }}>
                                                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                                                                <View style={{ flexDirection: 'row', gap: 6, alignItems: 'center' }}>
                                                                    <Image source={review.toUser.profile_image ? { uri: review.toUser.profile_image } : placeholderImage}
                                                                        style={[GlobalStyles.image24, { borderRadius: 20 }]}
                                                                    />
                                                                    <Text style={GlobalStyles.text14} > {review.toUser.name}</Text>
                                                            ...
                                                            <View style={{ flexDirection: 'row', gap: 0, alignItems: 'center' }}>
                                                                ...
                                                                <Text style={GlobalStyles.text12} > {review.toUser.totalReviews} reviews</Text>
...
export default ReviewNotificationScreen