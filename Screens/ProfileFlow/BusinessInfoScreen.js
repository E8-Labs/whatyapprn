...
const BusinessInfoScreen = ({ navigation, route }) => {
    ...
    const media = [
        {
            id: 1,
            name: 'Img2000139x352.png',
            caption: "caption content goes here and can be edited using the 3 dot on the right",
            ...
            <View style={GlobalStyles.container}>
                ...
                <View style={{ height: screenHeight * 0.86 }}>
                    <ScrollView showsVerticalScrollIndicator={false}>
                        <View style={{
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 15 }}>
                                ...
                                <View style={{ flexDirection: 'column', gap: 10 / 930 * screenHeight }}>
                                    ...
                                    <Text style={{ fontSize: 14, fontFamily: CustomFonts.InterMedium, color: Colors.lightBlack }}>
                                        Size: 2mb
                                    </Text>
                                </View>
                            </View>
                        ...
                        <TextInput
                            style={[GlobalStyles.input, { marginTop: 20 / 930 * screenHeight }]}
                            placeholder='Name'
                            value={name}
                            onChangeText={(text) => {
                                setName(text)
                        ...
                        <TouchableOpacity style={[GlobalStyles.input, { marginTop: 20 / 930 * screenHeight }]}
                            onPress={() => {
                        ...
                        <View style={[GlobalStyles.input, {
                            ...
                            >
                                <Image source={showpass ? require('../../assets/Images/eye.png') :
