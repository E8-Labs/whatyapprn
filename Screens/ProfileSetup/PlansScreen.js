    ...
    return (
        <SafeAreaView style={GlobalStyles.container}>
            <View style={[GlobalStyles.container, { alignItems: 'center', }]}>
                <View style={{ flexDirection: 'column', alignItems: 'center', height: screenHeight - 100, justifyContent: 'flex-end' }}>
                    <Text style={GlobalStyles.heading}>
                        Subscription Plan
                    </Text>
                    <Text style={[GlobalStyles.subheading14, { marginTop: 10,marginBottom:50/930*screenHeight }]}>
                        Lorem ipsum dor simet insnet
                    </Text>
                                    ...
                                    item.id === 1 && (
                                        <Image source={require('../../assets/Images/recommendedImage.png')}
                                            style={{
                                                ...
                                                zIndex: 2,alignSelf:'flex-end',marginRight:30/430*screenWidth,marginBottom:-45/930*screenHeight,
                    ...
                    <Text style={{
                        width: screenWidth - 40, fontSize: 13, fontFamily: CustomFonts.InterRegular,
                        marginTop: 30, textAlign: 'center'
                    }}>
                        This subscription automically renews unless auto-renew is turn off ateast 24hrs before current period eands. Payment is charged to your iTunes Account.
                    </Text>
                </View>
