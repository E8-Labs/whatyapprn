                            ...
                            <View key={item.id} style={{
                              ...
                              <View style={{
                                ...
                                <Text style={{ fontSize: 17, fontFamily: CustomFonts.InterMedium, color: "#00000080" }}>
                                  {item.city ? item.city : 'N/A'} {item.state && `, ${item.state}`}
                                </Text>
...

              {
                customersNearMe && customersNearMe.length > 0 ? (
                  customersNearMe.map((item) => (
                    ...
                    >
                      <View key={item.id} style={{
                        width: screenWidth - 40, alignItems: 'flex-start', flexDirection: 'row', gap: 15,
                        marginTop: 30 / 930 * screenHeight
                      }}>
                        ...
                        <View style={{
                          ...
                          height: 110 / 930 * screenHeight, marginLeft: 30 / 430 * screenWidth
                        }}>
